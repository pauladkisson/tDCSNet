    ...
    for ei = loop_ei
        ...
        for k = loop_k
            ...
            for trial = 1 : num_trials
                ...
                g_AMPA_cor = g_AMPA';
                g_AMPA_cor = repmat(g_AMPA_cor, num_cor*2, 1);
                g_NMDA_cor = g_NMDA';
                g_NMDA_cor = repmat(g_NMDA_cor, num_cor*2, 1);
                load(strcat(basepath, sprintf("/%0.0fHz_N=%0.0f", [bgi_fr, 1])));
                g_AMPA_int = g_AMPA';
                g_AMPA_int = repmat(g_AMPA_int, num_inter, 1);
                g_NMDA_int = g_NMDA';
                g_NMDA_int = repmat(g_NMDA_int, num_inter, 1);
